<h2><a href="https://leetcode.com/problems/digit-frequency-score/?envType=problem-list-v2&envId=hash-table">4321. Digit Frequency Score</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
